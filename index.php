        ...
        <section class="news">
            <section class="news-container">
                <section class="news-item">
                    ...
                    <p>Карл-Энтони Таунс и Энтони Эдвардс продемонстрировали высокую игру в четвертом матче серии,
                        заставив "Маверикс" уступить и предоставив "Тимбервулвз" шанс на пятый матч.</p>
                </section>
                <section class="news-item">
                    <h3>Победа "Бостона" в Восточной конференции.</h3>
                    <p>Джейсон Тейтум и Джейлен Браун продемонстрировали зрелую игру, что помогло "Селтикс" обеспечить
                        себе место в финале НБА.</p>
                </section>
                <section class="news-item">
                    <h3>Тимбервулвз настраиваются на матч 5.</h3>
                    <p>После напряженного четвертого матча "Миннесота" надеется сохранить свою игровую форму на домашнем
                        паркете.</p>
                </section>
                <section class="news-item">
                    <h3>Возвращение Макси Клебера.</h3>
                    <p>Важный игрок "Далласа" вернулся на площадку после травмы, что может укрепить их защиту и улучшить
                        игру под кольцом.</p>
                </section>
                <section class="news-item">
