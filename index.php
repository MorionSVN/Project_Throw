    ...
    <header>
        <svg class="logo" xmlns="http://www.w3.org/2000/svg" width="231" height="44" viewBox="0 0 231 44" fill="none">
            <g clip-path="url(#clip0_29_2)">
                <path d="M159.72 34.44C162.76 31.08 164.84 26.6 165 21.64H153.8C153.96 26.76 156.2 31.4 159.72 34.44Z"
                    fill="white" />
                <path
                ...
                <path
                    ...
                    fill="white" />
                <path d="M145.8 21.8V41C150.76 40.84 155.24 38.76 158.6 35.72C154.92 32.2 152.36 27.4 152.2 21.8H145.8Z"
                    fill="white" />
                <path
